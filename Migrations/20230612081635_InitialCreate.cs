    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuVarieties", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_MenuOptions_MenuOptionId",
                        column: x => x.MenuOptionId,
                        principalTable: "MenuOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Menus_MenuVarieties_MenuVarietyId",
                        column: x => x.MenuVarietyId,
                        principalTable: "MenuVarieties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Menus_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menus_MenuOptionId",
                table: "Menus",
                column: "MenuOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_Menus_MenuVarietyId",
                table: "Menus",
                column: "MenuVarietyId");

            migrationBuilder.CreateIndex(
                name: "IX_Menus_ReservationId",
                table: "Menus",
                column: "ReservationId");
